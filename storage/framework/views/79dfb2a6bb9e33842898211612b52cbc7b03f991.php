                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
                            ...
                            <div class="mt-2 flex items-center text-sm text-gray-500">
                                ...
                                <p class="text-gray-500 font-bold">PEC Cumplimiento: </p>&nbsp <p> <?php echo e($evaluacionfinal->pecc); ?></p>
                            </div>
                                            ...
                                            <div class="mt-4 space-y-4">
                                                <div class="flex items-start">
                                                    <div class="flex items-center h-5">
                                                        <input id="saludo1" name="saludo1" wire:model.lazy="saludo1" type="checkbox" value="checked" disabled="true" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300 rounded" <?php echo e($saludo1); ?>>
                                                    </div>                                                                   
...
<?php /**PATH C:\wamp64\www\sdmweb_devel\resources\views/evaluacions/revision.blade.php ENDPATH**/ ?>