...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('hzoNnju')) {
    $componentId = $_instance->getRenderedChildComponentId('hzoNnju');
    $componentTag = $_instance->getRenderedChildComponentTagName('hzoNnju');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hzoNnju');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('hzoNnju', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\wamp64\www\sdmweb_devel\resources\views/livewire/asignacion-index.blade.php ENDPATH**/ ?>