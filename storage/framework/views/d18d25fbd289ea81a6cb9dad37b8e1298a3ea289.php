...
} elseif ($_instance->childHasBeenRendered('dci05x8')) {
    $componentId = $_instance->getRenderedChildComponentId('dci05x8');
    $componentTag = $_instance->getRenderedChildComponentTagName('dci05x8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dci05x8');
} else {
    $response = \Livewire\Livewire::mount('pauta-digital', ['evaluacionid' => $evaluacionfinal->id]);
    $html = $response->html();
    $_instance->logRenderedChild('dci05x8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        </div>
...
<?php /**PATH C:\wamp64\www\sdmweb\resources\views/evaluacions/index.blade.php ENDPATH**/ ?>