...
} elseif ($_instance->childHasBeenRendered('wc1GFUi')) {
    $componentId = $_instance->getRenderedChildComponentId('wc1GFUi');
    $componentTag = $_instance->getRenderedChildComponentTagName('wc1GFUi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wc1GFUi');
} else {
    $response = \Livewire\Livewire::mount('asignacion-index', ['asignacionid' => $asignacionfinal->id]);
    $html = $response->html();
    $_instance->logRenderedChild('wc1GFUi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\wamp64\www\sdmweb_devel\resources\views/asignacions/listar.blade.php ENDPATH**/ ?>