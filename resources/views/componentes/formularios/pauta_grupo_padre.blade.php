        ...
        @foreach($grupos['primarios'][$padre] as $posicion => $hijo)
            <div class="flex items-start">
                ...
                <div class="ml-3 text-sm">
                    <label for="saludo2" class="font-medium @if($atributos[$hijo]->no_aplica) text-yellow-500 @elseif($atributos[$hijo]->check_ec == 1) text-red-600 @else text-gray-700 @endif @if($bloqueada) opacity-50 @endif">
                        {{ $atributos[$hijo]->name }}
