                            ...
                            <tr id="fila_{{ $evaluacion->id }}" class="hover:bg-gray-50">
                                ...
                                <td class="px-3 py-1 whitespace-nowrap">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full @if($evaluacion->estado_conversacion == 8) bg-green-100 text-green-800 @elseif(in_array($evaluacion->estado_conversacion, [9, 14, 15, 16])) bg-yellow-100 text-yellow-800 @else bg-gray-100 text-gray-800 @endif">
                                      {{ \App\Models\Estado::find($evaluacion->estado_conversacion)->name . ($evaluacion->comentario_grabacion == "" ? "" : " - Comentada") }}
                                    </span>
                    ...
                    <div id="modal-completar" class="@if($modalVisible) modal-active @else opacity-0 pointer-events-none @endif transition-all fixed w-full h-full top-0 left-0 flex items-center justify-center">
                        ...
                        <div class="modal-container bg-white w-11/12 md:max-w-xl mx-auto rounded shadow-lg z-50 overflow-y-auto">
                            ...
                            <div class="modal-content py-4 text-left px-6">
                                    ...
                                    @elseif(!empty($datosModal['ruta']) && $datosModal['ruta'] == "reportar_grabacion")
                                        ...
                                        <div>
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label inline-block text-gray-800" for="sin_problemas">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label inline-block text-gray-800" for="no_existe">
                                                    No existe
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label inline-block text-gray-800" for="no_evaluable">
                                            ...
                                            <div class="ml-10 mt-4 flex-row">
                                                <div id="ta_comentario" class="flex form-check flex-row pg @if($datosModal['estadoGrabacion'] !== "comentario") hidden @endif">
                                                    <textarea onchange="validarReportarGrabacion()" class="w-full mb-4 pg-cb form-check-input appearance-none rounded-md border border-gray-300 bg-white checked:bg-blue-600 checked:border-blue-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain float-left mr-2 cursor-pointer" name="comentario_grabacion" id="comentario_grabacion">{{ $evaluacion->comentario_grabacion }}</textarea>
                                                </div>
                                ...
                                <!--Footer-->
                                    <div class="space-x-2 flex justify-end pt-2 block">
                            ...
                            <script>
                                ...
                                function validarReportarGrabacion() {
                                    if (document.getElementById("sin_problemas").checked || document.getElementById("no_existe").checked) {
                                        ...
                                        if (document.getElementById("comentario_grabacion").value !== "" ) {
                                            activarGuardarModalCompletar();
                                        } else {
                                            desactivarGuardarModalCompletar();
